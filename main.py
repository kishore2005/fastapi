...
DATABASE_URL = "sqlitecloud://ce3yvllesk.g4.sqlite.cloud:8860/my-app?apikey=kOt8yvfwRbBFka2FXT1Q1ybJKaDEtzTya3SWEGzFbvE"
IMGBB_API_KEY = "43dbf9c00d857313ec47281400a87ca7"
...
@app.get("/")
def root():
    return {"message": "Product Management API", "version": "1.0.0", "status": "running"}
